...
public class Deter extends Question{
	...
	public Deter() {
		...
		this.setQuestion("L'automate donn� est-il d�terministe ?");
		this.setReminder("On pourra �crire Vrai, 1, ou True pour Vrai, Faux, 0 ou False pour Faux (attention aux majuscules)");
